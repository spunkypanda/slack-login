...
import { SLACK_AUTHORIZE_URL, SLACK_AUTHORIZE_REDIRECT_URI, SLACK_USER_SCOPES, SLACK_ACCESS_URL, SLACK_ACCESS_REDIRECT_URI } from '../../constants';
...
export const callAccessAPI = async (verifierCode: string) => {
  ...
  console.log('slackAccessUrl', slackAccessUrl);
